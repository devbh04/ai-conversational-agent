...
def read_config():
    ...
    return {
        "first_line": get_val("first_line", "FIRST_LINE", "Haan ji, namaskar! Aap kaunsi property dhundh rahe hain — buy karna hai ya rent?"),
  ...
  <div id="page-agent" class="page">
    ...
    <div class="section-card">
      ...
      <div class="form-group">
        ...
        <input type="text" id="first_line" value="{config.get('first_line', '')}" placeholder="Haan ji, namaskar! Aap kaunsi property dhundh rahe hain...">

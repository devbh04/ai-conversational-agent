...
_BASE_COLUMNS = {"phone_number", "duration_seconds", "transcript", "summary",
                 "caller_name", "property_preferences", "site_visit_time"}
...
def save_call_log(
    ...
    if property_preferences:        full_data["property_preferences"] = property_preferences
    if site_visit_time:             full_data["site_visit_time"]     = site_visit_time
